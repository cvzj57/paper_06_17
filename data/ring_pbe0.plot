...
#  set xtic rotate by -45 scale 0
  ...
  plot 'ring_pbe0_homo.dat' using 2         lt rgb "#83caff" t 'Reference alkenes',\
...
#  set xtic rotate by -45 scale 0
  ...
  set grid ytics ls -1
  set key top right
  plot 'ring_pbe0_ie.dat'   using 2         lt rgb "#ff950e" t 'Reference alkenes',\
...
#  set xtic rotate by -45 scale 0
  ...
  set grid ytics ls -1
  set key top right
  plot 'ring_pbe0_st.dat'   using 2         lt rgb "#aecf00" t 'Reference alkenes',\
...
#  set ylabel 'eV'
  ...
  set key top right
  set xlabel
  plot 'ring_pbe0_tddft.dat'   using 2:xtic(1) lt rgb "#aecf00" t 'Reference alkenes',\
       ''                       u     3         lt rgb "#579d1c" t 'Pseudo-alkenes'
unset multiplot
