...
which not only could be used in a QM/MM framework but also used by themselves could
interact in a physically sound manner and reproduce accurately some molecular properties.
For instance, in this article, we reproduce on the $\pi$ system and selected properties 
