...
Table \ref{table:potential_params} displays the data resulting from the step-by-step extraction described in Section REF. The \(p_{z}\) potential is selected using the procedure described, with the exponent chosen to give the maximum possible overlap with the \(p_{z}\) orbital,
