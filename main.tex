...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[A great physically meaningful pseudo-potential for sp\(^{2}\) carbon]
  {A great physically meaningful pseudo-potential for sp\(^{2}\) carbon}
...
\begin{figure}
\includegraphics[width=8cm, height=5cm]{long_r_diag.png}
\includegraphics[width=8cm, height=5cm]{short_r_diag.png}
...
\caption{DFT and TD-DFT (PBE0) comparison of reference and pseudo-system energies across a range of ring molecules. C\(_{54}\)H\(_{18}\) is a seriess of concencric rings of benzene as shown (bottom).}
...
system and long range the bi-electronic terms shall be very hard to reproduce by mono-electronic
operators.
