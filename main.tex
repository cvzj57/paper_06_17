...
Excitation energies computed with the pseudo-potential are systematically lower a red shift of
0.91 was used on the computed energies to match the reference spectra for the singlet.
