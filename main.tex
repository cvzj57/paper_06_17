...
MOLCAS program package.~\cite{MOLCAS}

Structures are optimized at the all-electron levels and the pseudo-systems are built by preserving
the optimised carbon-carbon distances.
...
\begin{center}
\includegraphics[angle=-90,width=8cm]{pbe0_grand_rpas}
\end{center}
{\Large
\begin{minipage}[t]{3in}
\baselineskip = .5\baselineskip
