...
Next, we take some of these potentials to create a pseudo-ethene system, with the results shown in Table \ref{table:ethene_s_pseudo}. [FURTHER COMMENTS].
...
\subsection{On Potential-Orbital Overlap}
