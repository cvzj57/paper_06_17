...
This gives a vision of the $\pi$-only electronic cloud, which is not straightforward to retrieve in all electron calculations.
...
located at the nucleus but rather at the maxima of the $\pi$ density, 
...
To fulfill the Poincarré-Hopf relationship, a cage critical point is required. However,
none of the algorithms we have used (REF???) finds this cage critical point 
at the center of the molecule, either in the reference or in the pseudo-potential 
calculations.
