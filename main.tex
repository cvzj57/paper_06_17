...
Since Hellmann and Gomb\'as' development of the first pseudo-potentials in the 1930s REF, pseudo-potential methods have been employed in a variety of theoretical chemistry problems. Recently, pseudo-potentials have been used to provide enhancements or corrections to other methods, with examples including their use as link atoms in QM/MM calculations, or the efforts by REF to use them alongside DFT calculations in correcting for DFT dispersion errors. Their primary use, however, has always been that of increasing computational efficiency as compared with more analytical solutions for the same systems. Most well-known among these methods is the Effective Core Potential (ECP) (REF), where the replacement of core electrons in larger atoms with ECPS and RECPs (Relativistic Effective Core Potentials) permits calculations on molecules involving such atoms to be more efficient. This is not to say, however, that pseudo-potentials have been employed only in the treatment of heavy atoms. There have been efforts to create potentials for use on some lighter atoms, such those of Topiol \emph{et al.} or Gresh and Pullman REF. 
...
Thus, this second term is not stricly equivalent to Huzinaga's $B_J$ terms as it aims at recovering
...
atoms once we started building molecules with our pseudo-carbon. Thinking therefore that we would attempt to keep the effects 
