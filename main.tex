...
This will mean producing potentials which are capable of bonding covalently with their all-electron neighbours, i.e. adding another electron to the pseudo-carbon for every bonding.
Our to be published preliminary results show that geometry optimization of the bond distances are possible.
