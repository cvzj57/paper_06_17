...
we intend to use. 
Teh replacement of bi-electronic interactions with a set of mono-electronic integrals
will result in drastic gains in timings.
The purpose of the current work is not to study the time gain from the use of the pseudo-potentials
that we extract but more to see whether our approach of extracting pseudo-potentials
for hybridised atoms is possible with strictly local pseudo-potentials.
A study of timings is yet available in the supplementary material.
