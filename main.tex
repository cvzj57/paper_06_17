...
(restricted formalism).
Calculations are at the PBE0/def-SV(P) level.
Molecule \textbf{[1]} to \textbf{[6]} are is represented in Figure \ref{fig:molecules}.}
...
\fbox{\includegraphics[width=5cm]{molecules}}
\end{center}
...
HOMO energy values for several ring systems, the largest of which is C$_{54}$H$_{18}$, shown in Figure~\ref{fig:molecules}.
