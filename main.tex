...
%and we too must choose some reference criteria for our potentials. 
...
We mention that, indeed, we used  Equation~\ref{eqpseudo} to get informed guesses for the coefficients of the starting parameters 
...
\hline
initial pseudo-CH$^{\bullet}_{3}$ & -3.268 & 0.295 & 10.381 & 10.0 & -10.537 & - & - \\
