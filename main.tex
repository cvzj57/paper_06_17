...
\subsection*{\sffamily \large General pseudo-potential definition}
...
\subsection*{\sffamily \large Extraction for the CH$_3^\bullet$ radical}
...
\subsection*{\sffamily \large Extraction in the general case for C sp$^2$ atoms}
...
Furthermore, we we expect our hypothesis to be grounded and should be able to
extract parameters on as few as possible data.
Thus, we extracted the optimal pseudo-potential by a step by step procedure described in 
the supplementry materials on the smallest $\pi$ system: the ethylene molecule.
...
\hline
$s$ potential & $C_J$ & $\gamma_J$ & $r^0_J$ \\
\hline
& 1.5 & 0.5   & 0.5590\\
\hline
$p$ potential & $A_I$ & $\alpha_I$ \\ 
\hline
& -3.91 & 0.624  \\
\hline
\end{tabular}
...
With parameters defined in Table \ref{tab:params}, the potential reproduces the properties of the ethylen $\pi$ cloud system with a good accuracy: relative errors on the ionisation energy and the energies of the HOMO orbital of 8\% and 3\% respectively (Table \ref{tab:res_ourPP}).

\begin{table}[ht]
\begin{tabular}{c c c c c}
& & $\Delta_{ST}$  & Ionisation  & $\varepsilon_{HOMO}$  \\
\hline
...
\hline
\end{tabular}
\caption{\label{tab:res_ourPP}Comparison of the properties of the referecen ethylen molecule and its reproduction with the optimal pseudo potential obtained in this work. Calculations are performed at the HF level, values are in atomic eV.}
\end{table}
