...
\hl{The QM/MM caping methods are to be cited.}\cite{ihrig_specific_2011,
...
\hl{As the aforementioned methods intend to fill the valence of dandling bonds
or to improve over the H-capping methods, the reference is the ground state
potential energy surface.
Sopme years ago, Sebastiani included successfully vibrational excited states in the pseudo potential
extraction method focusing on vibrational excitations.
We want to treat properly electronic excited states with our method.
The reproduction of the ground state potential energy surface will be the subject of a further
study on top of the current work.}
...
energy (IE) and energy of the HOMO orbital ($\varepsilon_{HOMO}$)
...
\begin{figure}
\begin{center}
\includegraphics[width=7cm]{short_pbe0}
...
\begin{figure}
\begin{center}
\fbox{\includegraphics[width=8cm]{molecules}}
\end{center}
\caption{\label{fig:molecules}Representation of the molecules \textbf{[1]} to \textbf{[6]}.}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[width=7cm]{ring_pbe0}
\end{center}
\caption{Comparison of the HOMO ($\varepsilon_{HOMO}$),
the ionisation (IE),
the first singlet-triplet $\pi-\pi^*$ excitation ($\Delta_{ST}$ and TD-DFT) energies
...
(restricted formalism).
Calculations are at the PBE0/def-SV(P) level.
Molecules \textbf{[1]} to \textbf{[6]} are represented in Figure \ref{fig:molecules}.}
\label{fig:rings_graphs}
\end{figure}

The potentials derived above are also tested on fused rings (Figure \ref{fig:molecules}), and larger chains.
Figure \ref{fig:rings_graphs} shows the $\Delta_{ST}$, the IE and
HOMO energy values for several ring systems, the largest of which is \textbf{[6]}: C$_{54}$H$_{18}$.
...
\begin{figure}
\begin{center}
\includegraphics[width=7cm]{long_pbe0}
...
As can be seen from }Figure~\ref{cnhn_2_uv} and \ref{cnhn_uv},\hl{the excitation energies as well as the
intensities of the excitations computed by TD-DFT are in extremely good agreement.}

\begin{figure}
%\vspace*{0.1in}   %%% FIGURE 8
\begin{center}
\includegraphics[width=12cm,angle=270]{cnhn_2_uv}
\end{center}
\vspace{0.25in}
\hspace*{3in}
\caption{Comparison of the UV spectra obtained with pseudo potentials and reference
	calculations def2-TZVP/TD-PBE0 for some all trans chain alkenes C$n$H$_{n+2}$.
	Two sets of pseudo-potentials
        are compared: "ps-new" refers to pseudo-potentials optimised for UV spectra.}
\label{fig:cnhn_uv}
\end{figure}

\begin{figure}
%\vspace*{0.1in}   %%% FIGURE 9
\begin{center}
...
\hspace*{3in}
\caption{Comparison of the UV spectra obtained with pseudo-potentials and reference
	calculations def2-TZVP/TD-PBE0 for some fused rings molecules. Two sets of pseudo-potentials
	are compared: "ps-new" refers to pseudo-potentials optimised for UV spectra.}
\label{fig:cnhn_uv}
\end{figure}
...
Secondly, we gave a physical meaning to all the pseudo-potential terms.
