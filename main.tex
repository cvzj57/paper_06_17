...
These calculations show that the pseudo-potentials that we have extracted
are able to reproduce the low-lying first excited state as well as the ionisation potential of a large range of PAH.

Encouraged by this, we decided to explore the virtual space further by computing the 20 first singlet and 20 first triplet 
...
calculation which involve excitation from $\sigma$ to $\sigma$ orbitals cannot be reproduced. These are denoted by a * above the peaks in the graphs.
...
These results show that the pseudo-potentials that we have extracted are able to reproduce the $\pi$ systems in a variety of situations which are not part of their extraction set.
We have also shown that the pseudo-potentials presented herein can be analysed through state-of-the-art methods (AIM in the present work).
...
This gives a vision of the $\pi$-only electronic cloud, which is not straightforward to get in all electron calculations.
Critical points are characterised by the sign of the eigenvalues of the hessian of the electronic density at their position
and are classified as follows.
As at the nuclei there are maxima of the electronic density, in all electron AIM analysis,
atoms are characterised by three negative eigenvalues of the hessian of the density noted (3, -3).
...
located at the nucleus but rather at the maxima of the $\pi$ density, \emph{i.e.} were the lobes of the $p$ orbitals admit a maximum.
...
calculations and that the pseudo-potentials lead to a more diffuse $\pi$ bonding pattern.
...
\hline
Mean \(\pi - \pi*\) Triplet-Singlet (RHF) error (\%) & 4.1 & 3.6 & 7.5 & 13.3 & 11.4 \\
Mean \(\pi - \pi*\) Triplet-Singlet (UHF) error (\%) & 6.9 & 3.6 & 7.5 & 13.3 & 11.4 \\
Mean Ionisation (RHF) error (\%) & 5.6 & 7.0 & 8.8 & 11.3 & 9.9 \\
Mean Ionisation (UHF) error (\%) & 7.7 & 6.9 & 8.8 & 11.3 & 9.9 \\
Mean Singlet HOMO (RHF) error (\%) & 1.3 & 4.2 & 9.3 & 13.7 & 10.7 \\
Mean Singlet HOMO (UHF) error (\%) & 2.2 & 4.2 & 9.3 & 14.5 & 10.0 \\
Mean TD-DFT Excitation error (\%) & 10.2 & 2.6 & 2.7 & 5.9 & 6.4 \\ 
\hline
\end{tabular}
...
Calculation Type & HF & PBE0 & PBE & TPSS & TPSSH \\
\hline
Mean \(\pi - \pi*\) Triplet-Singlet (RHF) error (\%) & 3.3 & 1.9 & 1.7 & 6.8 & 6.7 \\
Mean \(\pi - \pi*\) Triplet-Singlet (UHF) error (\%) & 9.1 & 2.1 & 5.7 & 6.7 & 7.1 \\
Mean Ionisation (RHF) error (\%) & 7.9 & 12.0 & 15.4 & 18.0 & 16.1 \\
Mean Ionisation (UHF) error (\%) & 13.4 & 12.0 & 18.8 & 18.0 & 16.1 \\
Mean Singlet HOMO (RHF) error (\%) & 4.7 & 11.5 & 17.1 & 22.3 & 18.7 \\
Mean Singlet HOMO (UHF) error (\%) & 2.3 & 11.5 & 18.1 & 21.1 & 21.2 \\
Mean TD-DFT Excitation error (\%) & 11.8 & 4.4 & 2.6 & 5.9 & 6.5 \\ 
\hline
\end{tabular}
...
Calculation Type & HF & PBE0 & PBE & TPSS & TPSSH \\
\hline
Mean \(\pi - \pi*\) Triplet-Singlet (RHF) error (\%) & 125.7 & 58.3 & 47.2 & 182.0 & 155.6 \\
Mean \(\pi - \pi*\) Triplet-Singlet (UHF) error (\%) & 302.6 & 5.1 & 21.1 & 26.3 & 15.5 \\
Mean Ionisation (RHF) error (\%) & 35.8 & 6.6 & 10.3 & 11.3 & 11.2 \\
Mean Ionisation (UHF) error (\%) & 184.0 & 10.3 & 11.8 & 18.9 & 18.7 \\
Mean Singlet HOMO (RHF) error (\%) & 1.8 & 7.8 & 12.8 & 20.1 & 15.7 \\
Mean Singlet HOMO (UHF) error (\%) & 14.2 & 7.3 & 11.8 & 15.4 & 16.9 \\
Mean TD-DFT Excitation error (\%) & 23.1 & 1.0 & 6.8 & 6.1 & 2.9 \\ 
\hline
\end{tabular}
