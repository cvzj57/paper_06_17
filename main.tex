...
Finally, this approach is capable of reproducing the $\pi$ electron systems of small or large, planar or near-planar hydrocarbons at low computational cost.
\end{abstract}
...
(6) They were employed to compute  UV and ECD spectra of extended, near-planar systems: helicenes
and a coronene embedded in a nanotube. Despite the fact that our method does not reach chemical
accuracy in ionisation energies, it can be useful to solve highly difficult assignations
for large systems in a limited time.
