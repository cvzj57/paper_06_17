...
\begin{figure}
\includegraphics[width=8cm, height=8cm]{long_r_ethene_diagram.png}
\includegraphics[width=8cm, height=8cm]{short_r_ethene_diagram.png}
\caption{Diagrams of pseudo-ethene with \(d =\) 2.0 a.u. (left), and \(d = 0.5\) a.u. (right). Pseudo-carbon atoms are displayed in grey and \(s\) pseudo-potentials are displayed in white.}
...
The next steps to be done in the framework of this study are the following: the addition of an explicit
...
system. 
%and long range the bielectronic terms shall be very hard to reproduce by monoelectronic
%operators.
