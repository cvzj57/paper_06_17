...
wanted orbitals.
We show in this work that for our purpose, this term is not needed.
...
The second part shows the results obtained with the optimal pseudo-potential, 
...
\end{center}
\caption{Comparison of the HOMO energy ($\varepsilon_{HOMO}$), the ionisation energy (I.E.) and
the first singlet-triplet excitation energy ($\Delta_{ST}$) between the
