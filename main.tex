...
\vspace{0.25in}
\hspace*{3in}
\caption{Comparison of the absorption spectra for the first 20 excitations obtained with pseudo-potentials (ps) and all-electron (ref) calculations (def2-SV(P)/TD-PBE0).}
\label{fig:cnhn_uv}
\end{figure}
