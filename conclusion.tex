...
Based on this general statement, many successful theoretical approaches were developed.
...
In this operator we notice that the \(r^{n}\) behavior is maintained for the first term 
(the Coulomb one).
...
chemical groups, as in the case of the cyclopentadienyl anion cited here above.
