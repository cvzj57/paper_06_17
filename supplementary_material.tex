...
\end{figure}
Figure \ref{fig:alkenes_tddft} shows excitation energy of the first triplet $\pi$ excited state
for the six short polenes studied in the article.
These excitation energies are obtained at the same level of theory with the previous
