...
\end{center}
\caption{Comparison of CASSCF (ROHF) calculations for frozen-orbital and pseudo-molecule systems across a series of short chain alkenes.}
\label{fig:froz_comp}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=16cm]{b3_rings_rpas}
\end{center}
\vspace{0.25in}
\hspace*{3in}
\caption{Comparison of the absorption spectra for the 20 first singlet excitations obtained with
